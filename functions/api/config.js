export async function onRequestGet(context) {
    ...
    return new Response(JSON.stringify({ backgroundUrl, backgroundOpacity: backgroundOpacity || "0.4" }), {
...
export async function onRequestPost(context) {
    ...
    const { backgroundUrl, backgroundOpacity, token } = await request.json();
